...
df = pd.read_csv("/home/ubuntu/preds/preds_raw_processed_test.csv")
...
for i in range(len(preds)):
    final_preds.append(np.average(preds[i]))
...
pred_df.to_csv(f"/home/ubuntu/submission/average_ensemble.csv", index=False)
